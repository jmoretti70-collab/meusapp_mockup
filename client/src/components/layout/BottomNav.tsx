...
export default function BottomNav() {
  ...
  return (
    <nav className="absolute bottom-0 left-0 right-0 h-20 bg-card/95 backdrop-blur-lg border-t border-border/50 flex items-center justify-around px-2 pb-4 z-50">
      {navItems.map((item) => {
